...
let tp = path.join(__dirname, './AzureInitSuccessMalformedAuthenticationSchemeL0.js');
...
process.env['ENDPOINT_AUTH_SCHEME_AzureRM'] = 'randomStringToSimulateMalformedScheme';
